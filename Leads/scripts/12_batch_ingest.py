...
# --- T3 Run-5 (156): all remaining uncovered investable T1/T2/T3 firms ---
# Mostly large-cap (ARS 40 down to ~20). Completes investable-universe coverage.
T3_RUN5 = {
    "BELRISE": ("TK988690", "Belrise"),
    "HAL": ("TK785781", "Hindustan Aeronautics"),
    "KIMS": ("TK881639", "Krishna Institute of Medical"),
    "DMART": ("TK704418", "Avenue Supermarts"),
    "GODREJPROP": ("TK496733", "Godrej Properties"),
    "ARVINDFASN": ("TK787627", "Arvind Fashions"),
    "SURYAROSNI": ("TK183388", "Surya Roshni"),
    "ELGIEQUIP": ("TK168488", "Elgi Equipments"),
    "DLF": ("TK382393", "DLF"),
    "CCL": ("TK372990", "CCL Products"),
    "JSL": ("TK202860", "Jindal Stainless"),
    "FSL": ("TK363055", "Firstsource"),
    "ZFCVINDIA": ("TK379812", "ZF Commercial Vehicle"),
    "JSWDULUX": ("__WEB__", "JSW Dulux"),
    "BOSCHLTD": ("TK529696", "Bosch Ltd"),
    "JBCHEPHARM": ("TK758679", "J.B. Chemicals"),
    "ZYDUSWELL": ("TK576844", "Zydus Wellness"),
    "SUMICHEM": ("TK797347", "Sumitomo Chemical India"),
    "EMIL": ("TK922536", "Electronics Mart"),
    "IRCTC": ("TK833956", "Indian Railway Catering"),
    "JKTYRE": ("TK717166", "JK Tyre"),
    "BLUESTARCO": ("__WEB__", "Blue Star"),
    "BRIGADE": ("TK412831", "Brigade Enterprises"),
    "INDGN": ("TK959895", "Indegene"),
    "PATANJALI": ("TK782976", "Patanjali Foods"),
    "JAIBALAJI": ("TK215939", "Jai Balaji"),
    "CHAMBLFERT": ("TK237950", "Chambal Fertilisers"),
    "MINDACORP": ("__WEB__", "Minda Corporation"),
    "JAYNECOIND": ("TK93795", "Jayaswal NECO"),
    "BPCL": ("TK179925", "Bharat Petroleum"),
    "MANKIND": ("TK934698", "Mankind Pharma"),
    "UNITDSPR": ("TK116574", "United Spirits"),
    "ENGINERSIN": ("TK5715", "Engineers India"),
    "VGUARD": ("TK420863", "V-Guard"),
    "EUREKAFORB": ("TK859450", "Eureka Forbes"),
    "JYOTHYLAB": ("TK409222", "Jyothy Labs"),
    "BHARATFORG": ("TK758706", "Bharat Forge"),
    "ABBOTINDIA": ("TK104201", "Abbott India"),
    "SONACOMS": ("TK881053", "Sona BLW"),
    "THERMAX": ("TK346383", "Thermax"),
    "NUVOCO": ("__WEB__", "Nuvoco Vistas"),
    "SUBROS": ("TK163655", "Subros"),
    "VOLTAS": ("TK758872", "Voltas"),
    "MRF": ("__WEB__", "MRF"),
    "ABDL": ("__WEB__", "Allied Blenders"),
    "LTFOODS": ("TK357122", "LT Foods"),
    "ESCORTS": ("TK531474", "Escorts Kubota"),
    "ZYDUSLIFE": ("TK67084", "Zydus Lifesciences"),
    "KSB": ("__WEB__", "KSB"),
    "NATIONALUM": ("__WEB__", "National Aluminium"),
    "AVANTIFEED": ("TK424944", "Avanti Feeds"),
    "INDUSTOWER": ("TK608891", "Indus Towers"),
    "EMCURE": ("TK963629", "Emcure"),
    "CRAFTSMAN": ("TK873113", "Craftsman Automation"),
    "CGPOWER": ("__WEB__", "CG Power"),
    "JKCEMENT": ("TK265448", "JK Cement"),
    "IKS": ("TK975533", "Inventurus Knowledge"),
    "VEDL": ("TK162199", "Vedanta Ltd"),
    "AIAENG": ("TK308736", "AIA Engineering"),
    "APOLLOHOSP": ("TK179064", "Apollo Hospitals"),
    "SANSERA": ("TK890792", "Sansera Engineering"),
    "ADANIPOWER": ("TK482665", "Adani Power"),
    "ULTRACEMCO": ("TK235070", "UltraTech Cement"),
    "FORTIS": ("TK375566", "Fortis Healthcare"),
    "ENRIN": ("TK982893", "Siemens Energy India"),
    "NTPCGREEN": ("TK973802", "NTPC Green"),
    "NH": ("TK706225", "Narayana Hrudayalaya"),
    "JSWINFRA": ("TK705926", "JSW Infrastructure"),
    "APLAPOLLO": ("TK107443", "APL Apollo"),
    "KNRCON": ("TK419041", "KNR Constructions"),
    "ADANIENT": ("TK325207", "Adani Enterprises"),
    "VBL": ("TK729885", "Varun Beverages"),
    "ABB": ("TK751592", "ABB India"),
    "MEDANTA": ("__WEB__", "Global Health"),
    "MEDPLUS": ("TK899508", "Medplus Health"),
    "NATCOPHARM": ("TK340159", "Natco Pharma"),
    "HSCL": ("TK186618", "Himadri Special"),
    "GALLANTT": ("TK320613", "Gallantt Ispat"),
    "BBOX": ("__WEB__", "Black Box"),
    "WAAREERTL": ("TK597719", "Waaree Renewable"),
    "TENNIND": ("1205234100777431852", "Tenneco Clean Air"),
    "ACC": ("__WEB__", "ACC Ltd"),
    "GABRIEL": ("TK168719", "Gabriel India"),
    "ADANIPORTS": ("TK406787", "Adani Ports"),
    "BIKAJI": ("TK924343", "Bikaji Foods"),
    "RALLIS": ("TK533427", "Rallis India"),
    "EICHERMOT": ("TK758691", "Eicher Motors"),
    "MARUTI": ("TK193731", "Maruti Suzuki"),
    "KALYANKJIL": ("TK873430", "Kalyan Jewellers"),
    "ORIENTCEM": ("TK561332", "Orient Cement"),
    "KEI": ("TK338093", "KEI Industries"),
    "ASTERDM": ("TK783817", "Aster DM Healthcare"),
    "MEDANTA": ("__WEB__", "Global Health"),
    "TIMETECHNO": ("TK379960", "Time Technoplast"),
    "ENDURANCE": ("TK728175", "Endurance Technologies"),
    "MAXHEALTH": ("TK811204", "Max Healthcare"),
    "PGEL": ("TK563966", "PG Electroplast"),
    "BHEL": ("TK180461", "Bharat Heavy Electricals"),
    "DIXON": ("TK766161", "Dixon Technologies"),
    "AVL": ("TK733156", "Aditya Vision"),
    "SCHNEIDER": ("TK550543", "Schneider Electric Infrastructure"),
    "KAYNES": ("TK924854", "Kaynes Technology"),
    "SKIPPER": ("__WEB__", "Skipper"),
    "GRAVITA": ("TK530529", "Gravita India"),
    "JWL": ("TK526595", "Jupiter Wagons"),
    "GOKULAGRO": ("TK698060", "Gokul Agro"),
    "SENCO": ("TK938216", "Senco Gold"),
    "TRANSRAILL": ("TK976043", "Transrail Lighting"),
    "BHARTIARTL": ("TK139449", "Bharti Airtel"),
    "GODREJPROP": ("TK496733", "Godrej Properties"),
    "KIMS": ("__WEB__", "Krishna Institute of Medical"),
    "HAL": ("TK785781", "Hindustan Aeronautics"),
    "BELRISE": ("TK988690", "Belrise"),
    "BEL": ("TK205494", "Bharat Electronics"),
    "TORNTPHARM": ("TK236481", "Torrent Pharmaceuticals"),
    "SOLARINDS": ("TK320614", "Solar Industries"),
    "TRENT": ("__WEB__", "Trent Ltd"),
    "POLYCAB": ("TK815934", "Polycab"),
    "UNOMINDA": ("TK491771", "UNO Minda"),
    "OBEROIRLTY": ("TK527238", "Oberoi Realty"),
    "AJANTPHARM": ("__WEB__", "Ajanta Pharma"),
    "NAVINFLUOR": ("TK176129", "Navin Fluorine"),
    "NYKAA": ("__WEB__", "FSN E-Commerce"),
    "AMBER": ("TK781255", "Amber Enterprises"),
    "COCHINSHIP": ("TK762053", "Cochin Shipyard"),
    "GRAVITA": ("TK530529", "Gravita India"),
    "JWL": ("TK526595", "Jupiter Wagons"),
    "GOKULAGRO": ("TK698060", "Gokul Agro"),
    "SENCO": ("TK938216", "Senco Gold"),
    "TRANSRAILL": ("TK976043", "Transrail Lighting"),
    "ACE": ("TK341965", "Action Construction"),
    "PRIVISCL": ("TK283304", "Privi Special"),
    "WELCORP": ("TK685738", "Welspun Corp"),
    "HINDCOPPER": ("TK271030", "Hindustan Copper"),
    "PNGJL": ("TK968455", "P N Gadgil"),
    "POWERMECH": ("TK695001", "Power Mech"),
    "BLS": ("TK720175", "BLS International"),
    "VMM": ("TK975438", "Vishal Mega Mart"),
    "SYRMA": ("TK919691", "Syrma SGS"),
    "CEATLTD": ("__WEB__", "Ceat"),
    "PRICOLLTD": ("__WEB__", "Pricol"),
    "TEXRAIL": ("__WEB__", "Texmaco Rail"),
    "ANANTRAJ": ("__WEB__", "Anant Raj"),
    "TECHNOE": ("__WEB__", "Techno Electric"),
    "SAGILITY": ("__WEB__", "Sagility"),
    "GRSE": ("__WEB__", "Garden Reach"),
    "THANGAMAYL": ("__WEB__", "Thangamayil"),
    "CEMPRO": ("__WEB__", "Cemindia"),
    "BANCOINDIA": ("__WEB__", "Banco Products"),
    "JAINREC": ("__WEB__", "Jain Resource Recycling"),
    "ASHAPURMIN": ("__WEB__", "Ashapura Minechem"),
    "APARINDS": ("TK54014", "Apar Industries"),
    "LUMAXTECH": ("TK354841", "Lumax Auto Technologies"),
    "WAAREEENER": ("TK971420", "Waaree Energies"),
    "HBLENGINE": ("TK78027", "HBL Engineering"),
    "RRKABEL": ("TK942608", "R R Kabel"),
    "ASKAUTOLTD": ("TK947414", "ASK Automotive"),
    "RADICO": ("TK165507", "Radico Khaitan"),
    "TARIL": ("TK412881", "Transformers And Rectifiers"),
    "GODFRYPHLP": ("TK168727", "Godfrey Phillips"),
    "SKYGOLD": ("TK803200", "Sky Gold"),
    "SHRIPISTON": ("__WEB__", "Shriram Pistons"),
    "CPPLUS": ("__WEB__", "Aditya Infotech"),
    "EMMVEE": ("__WEB__", "Emmvee Photovoltaic"),
    "UTLSOLAR": ("__WEB__", "Fujiyama Power"),
    "SAATVIKGL": ("__WEB__", "Saatvik Green"),
}
...
def main():
    ...
    universe = {**T1, **T3, **T3_RUN3, **T3_RUN4, **T3_RUN5}
